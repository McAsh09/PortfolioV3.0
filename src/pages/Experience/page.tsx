      ...
      <div className="@container mx-auto max-w-5xl px-6 relative">
        ...
        >
          ...
          <ExperienceCard
            ...
            description="Worked on creating and enhancing shipment plans along with migration of configs to different build systems"
            icon={<Briefcase />}
          />
          ...
          <ExperienceCard
            ...
            description="Worked on creating build systems for trading platforms and integrated them with APIs"
            icon={<Briefcase />}
          />
          ...
          <ExperienceCard
            ...
            description="Working in GenAI and Retail Domain"
            icon={<Briefcase />}
          />
        </motion.div>
      </div>
