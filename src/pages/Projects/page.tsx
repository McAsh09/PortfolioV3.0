...
const ProjectShowcase = () => {
  ...
  const projects = [
    {
      title: "Hobby Project",
      description: "A tool to create a collection of projects",
      tags: ["JavaScript", "React", "Web Development"],
      links: {
        github: "https://github.com/McAsh09/hobby-projects",
        demo: "my-hobby-projects.netlify.app/",
      },
      // image: HobbyProject,
      featured: true,
    },
    {
      title: "Drum Kit",
      description:
        "Play the drum kit by pressing the keys on your keyboard or by clicking on the buttons",
      tags: ["React", "Tailwind CSS", "Portfolio", "Typescript"],
      links: {
        github: "https://github.com/McAsh09/drum-kit",
        demo: "https://mcash09.github.io/drum-kit/",
      },
      featured: true,
    },
    {
      title: "Simon Game",
      description: "Play the Simon game by clicking on the buttons",
      tags: ["React", "Tailwind CSS", "Portfolio", "Typescript"],
      links: {
        github: "https://github.com/McAsh09/simon-game",
        demo: "https://mcash09.github.io/simon-game/",
      },
      featured: true,
    },
    {
      title: "Crypto World",
      description: "Get latest updates about crypto world",
      tags: ["React", "Tailwind CSS", "Portfolio", "Typescript"],
      links: {
        github: "https://github.com/McAsh09/crypto-world",
        demo: "https://crypto-world-js.netlify.app/",
      },
      featured: true,
    },
  ];
