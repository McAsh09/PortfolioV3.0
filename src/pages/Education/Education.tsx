  ...
  const educationData = [
    {
      ...
      mascot: "📘",
      year: "2006-2018",
      achievements: ["Percentage: 92.5", "Subject: Science"],
    ...
    },
    {
      ...
      school: "Indian Institute of Information Technology (IIIT) Vadodara",
      mascot: "📗",
      year: "2019-2023",
      achievements: ["GPA: 7.8", "Subject: Computer Science"],
      skills: ["Data Structures and Algorithms", "Object-Oriented Programming", "Database Management", "Web Development"],
      description:
        "Focused on advanced computer science subjects and practical experience in software development and data science.",
    },
  ];
